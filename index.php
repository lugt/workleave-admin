...
function getTeach(){
	...
	if($an == NULL || $an == FALSE){
		...
		Mod_Authorize::errp("<h1>".$an."</h1>","<h3>教师姓名 : ".$an.
		"<br> 教师身份：".$ar.
		"<br> 教师电话：".$p.
		"<br> 办公电话：".$ot."".
		"<br> 备注：".$memo."</br>".
